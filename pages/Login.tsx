...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 p-4">
      <div className="w-full max-w-sm p-6 md:p-8 space-y-6 md:space-y-8 bg-white rounded-2xl shadow-xl">
        <div className="text-center">
            <div className="inline-block p-3 bg-emerald-500 rounded-xl mb-3 md:mb-4">
              <ShoppingCart className="w-6 h-6 md:w-8 md:h-8 text-white" />
            </div>
            <h1 className="text-xl md:text-2xl font-bold text-slate-900">AK Alheri Chemist</h1>
            <p className="text-xs md:text-sm text-slate-500">Please sign in to continue</p>
        </div>
