    ...
    return (
        <div className="space-y-4 md:space-y-8">
            <div className="flex justify-between items-end">
                <h1 className="text-xl md:text-2xl font-bold text-slate-800">Business Overview</h1>
                <div className="text-xs text-slate-500">{format(new Date(), 'EEEE, MMMM do, yyyy')}</div>
            </div>

            {/* SECTION 1: Daily Pulse */}
            <div>
                <h2 className="text-[10px] md:text-sm font-semibold text-slate-500 uppercase tracking-wider mb-2 md:mb-3">Daily Pulse</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
                    {/* Net Sales Card */}
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center bg-gradient-to-br from-emerald-50 to-white">
                        <div>
                            <p className="text-xs md:text-sm font-medium text-slate-500">Net Sales (Today)</p>
                            <h3 className="text-xl md:text-2xl font-bold text-emerald-700">₦{stats.netSalesToday.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <div className="flex items-center gap-1 text-[10px] md:text-xs text-emerald-600 mt-1">
                                <ArrowUpRight className="w-3 h-3" />
                                <span>Actual Cash Flow</span>
                            </div>
                        </div>
                        <div className="p-2 md:p-3 bg-emerald-100 rounded-full border border-emerald-200">
                            <Wallet className="w-5 h-5 md:w-6 md:h-6 text-emerald-600" />
                        </div>
                    </div>

                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
                        <div>
                            <p className="text-xs md:text-sm font-medium text-slate-500">Gross Sales</p>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.todaySales.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <div className="flex items-center gap-1 text-[10px] md:text-xs text-emerald-600 mt-1">
                                <ArrowUpRight className="w-3 h-3" />
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
                        <div>
                            <p className="text-xs md:text-sm font-medium text-slate-500">Today's Refunds</p>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.totalRefundAmountToday.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <div className="flex items-center gap-1 text-[10px] md:text-xs text-red-500 mt-1">
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
                        <div>
                            <p className="text-xs md:text-sm font-medium text-slate-500">Paid Expenses</p>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.todayExpenses.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <div className="flex items-center gap-1 text-[10px] md:text-xs text-red-500 mt-1">
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
                        <div>
                            <p className="text-xs md:text-sm font-medium text-slate-500">Low Stock</p>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">{stats.lowStockItems}</h3>
                            <p className="text-[10px] md:text-xs text-slate-400 mt-1">Items to order</p>
                        </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="p-1.5 md:p-2 bg-slate-100 rounded-lg text-slate-600"><CreditCard className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <p className="text-xs md:text-sm font-medium text-slate-600">Total Expenses</p>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.totalExpenses.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <p className="text-[10px] md:text-xs text-slate-400 mt-1">Lifetime paid expenses</p>
                        </div>
                    </div>
                    ...
                    {isAdmin && (
                        <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-2 mb-2">
                                    <div className="p-1.5 md:p-2 bg-blue-100 rounded-lg text-blue-600"><Package className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                    <p className="text-xs md:text-sm font-medium text-slate-600">Inventory Value</p>
                                </div>
                                <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.inventoryValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                                <p className="text-[10px] md:text-xs text-slate-400 mt-1">Asset valuation (Cost)</p>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="p-1.5 md:p-2 bg-purple-100 rounded-lg text-purple-600"><TrendingDown className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <p className="text-xs md:text-sm font-medium text-slate-600">Total Refunds (Month)</p>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.totalRefundAmountThisMonth.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <p className="text-[10px] md:text-xs text-slate-400 mt-1">Refunds issued this month</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="p-1.5 md:p-2 bg-rose-100 rounded-lg text-rose-600"><AlertTriangle className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <p className="text-xs md:text-sm font-medium text-slate-600">Damaged Value (Month)</p>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">₦{stats.totalValueDamagedThisMonth.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
                            <p className="text-[10px] md:text-xs text-slate-400 mt-1">Value lost from damaged returns</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="p-1.5 md:p-2 bg-emerald-100 rounded-lg text-emerald-600"><TrendingDown className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <p className="text-xs md:text-sm font-medium text-slate-600">Return Rate (Month)</p>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900">{stats.returnRateThisMonth.toFixed(2)}%</h3>
                            <p className="text-[10px] md:text-xs text-slate-400 mt-1">Refunds / Total Sales</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                <div className="lg:col-span-2 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200">
                    <div className="flex justify-between items-center mb-4 md:mb-6">
                        <h2 className="text-base md:text-lg font-semibold text-slate-800">Weekly Sales Performance</h2>
                        <span className="text-[10px] md:text-xs text-slate-500 bg-slate-100 px-2 py-1 rounded">Last 7 Days</span>
                    </div>
                ...
                <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200">
                    <h2 className="text-base md:text-lg font-semibold text-slate-800 mb-3 md:mb-4">Quick Actions</h2>
                    <div className="space-y-2 md:space-y-3">
                        <button
                            onClick={() => navigate('/pos')}
                            className="w-full flex items-center gap-3 p-2.5 md:p-3 rounded-lg border border-slate-100 hover:bg-emerald-50 hover:border-emerald-100 transition-all duration-200 text-left group"
                        >
                            <div className="bg-emerald-100 p-1.5 md:p-2 rounded-md text-emerald-600 group-hover:scale-110 transition-transform"><ShoppingBag className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            <div>
                                <p className="font-medium text-slate-700 text-xs md:text-sm">New Sale</p>
                                <p className="text-[10px] text-slate-400">Go to POS</p>
                            </div>
                        </button>
                        {isAdmin && (
                            <button
                                onClick={() => navigate('/inventory')}
                                className="w-full flex items-center gap-3 p-2.5 md:p-3 rounded-lg border border-slate-100 hover:bg-blue-50 hover:border-blue-100 transition-all duration-200 text-left group"
                            >
                                <div className="bg-blue-100 p-1.5 md:p-2 rounded-md text-blue-600 group-hover:scale-110 transition-transform"><Package className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <div>
                                    <p className="font-medium text-slate-700 text-xs md:text-sm">Add Inventory</p>
                                    <p className="text-[10px] text-slate-400">Restock products</p>
                                </div>
                            </button>
                        )}
                        <button
                            onClick={() => navigate('/customers')}
                            className="w-full flex items-center gap-3 p-2.5 md:p-3 rounded-lg border border-slate-100 hover:bg-orange-50 hover:border-orange-100 transition-all duration-200 text-left group"
                        >
                            <div className="bg-orange-100 p-1.5 md:p-2 rounded-md text-orange-600 group-hover:scale-110 transition-transform"><Users className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            <div>
                                <p className="font-medium text-slate-700 text-xs md:text-sm">Add Customer</p>
                                <p className="text-[10px] text-slate-400">Register new client</p>
                            </div>
                        </button>
                        {isAdmin && (
                            <button
                                onClick={() => navigate('/reports')}
                                className="w-full flex items-center gap-3 p-2.5 md:p-3 rounded-lg border border-slate-100 hover:bg-purple-50 hover:border-purple-100 transition-all duration-200 text-left group"
                            >
                                <div className="bg-purple-100 p-1.5 md:p-2 rounded-md text-purple-600 group-hover:scale-110 transition-transform"><TrendingDown className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                                <div>
                                    <p className="font-medium text-slate-700 text-xs md:text-sm">View Reports</p>
                                    <p className="text-[10px] text-slate-400">Full business analytics</p>
                                </div>
                            </button>
                        )}
                    </div>
