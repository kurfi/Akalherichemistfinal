    ...
    return (
        <div className="space-y-4 md:space-y-6 pb-20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h1 className="text-xl md:text-2xl font-bold text-slate-800">Business Intelligence</h1>
                <div className="flex gap-2">
                    <button
                        onClick={generatePDF}
                        className="flex-1 md:flex-none bg-slate-800 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg hover:bg-slate-700 flex items-center justify-center gap-2 shadow-sm text-xs md:text-sm"
                    >
                        <FileText className="w-3.5 h-3.5 md:w-4 md:h-4" /> PDF Report
                    </button>
                </div>
            </div>
            ...
            <div className="bg-white p-3 md:p-4 rounded-xl shadow-sm border border-slate-200">
                <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                    <div className="flex gap-1 p-1 bg-slate-100 rounded-lg w-full lg:w-auto overflow-x-auto">
                        {(['today', 'week', 'month', 'year'] as const).map(preset => (
                            <button
                                key={preset}
                                onClick={() => handleSetPreset(preset)}
                                className={`flex-1 lg:flex-none px-2.5 md:px-3 py-1 md:py-1.5 rounded-md text-[10px] md:text-sm font-medium capitalize transition-all ${activePreset === preset ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                                    }`}
                            >
                                {preset}
                            </button>
                    ...
                    <div className="flex items-center gap-2 w-full lg:w-auto">
                        <input
                            ...
                            className="flex-1 lg:flex-none p-1.5 md:p-2 border border-slate-200 rounded-lg text-xs md:text-sm outline-none focus:border-emerald-500"
                        />
            ...
            {/* Tabs Navigation */}
            <div className="flex flex-wrap gap-2 border-b border-slate-200 pb-3 md:pb-4">
                <TabButton id="overview" label="Overview" icon={<PieIcon className="w-3.5 h-3.5 md:w-4 md:h-4" />} />
                <TabButton id="sales" label="Sales" icon={<TrendingUp className="w-3.5 h-3.5 md:w-4 md:h-4" />} />
                <TabButton id="inventory" label="Inventory" icon={<Package className="w-3.5 h-3.5 md:w-4 md:h-4" />} />
                <TabButton id="financials" label="Financials" icon={<span className="w-3.5 h-3.5 md:w-4 md:h-4 flex items-center justify-center font-bold text-[10px] md:text-xs">₦</span>} />
                <TabButton id="returnAnalytics" label="Returns" icon={<RotateCcw className="w-3.5 h-3.5 md:w-4 md:h-4" />} />
            </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4">
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Total Sales</p>
                                    <h3 className="text-sm md:text-xl font-bold text-emerald-600 mt-1">₦{totalRevenue.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-emerald-100 rounded-lg text-emerald-600"><TrendingUp className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Cost of Goods</p>
                                    <h3 className="text-sm md:text-xl font-bold text-slate-700 mt-1">₦{totalCOGS.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-slate-100 rounded-lg text-slate-600"><Package className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Gross Profit</p>
                                    <h3 className="text-sm md:text-xl font-bold text-blue-600 mt-1">₦{grossProfit.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-blue-100 rounded-lg text-blue-600"><DollarSign className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Total Expenses</p>
                                    <h3 className="text-sm md:text-xl font-bold text-red-500 mt-1">₦{totalExpenses.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-red-100 rounded-lg text-red-600"><CreditCard className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Net Profit</p>
                                    <h3 className={`text-sm md:text-xl font-bold mt-1 ${netProfit >= 0 ? 'text-emerald-600' : 'text-red-500'}`}>
                                        ₦{netProfit.toLocaleString()}
                                    </h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-purple-100 rounded-lg text-purple-600"><span className="w-3.5 h-3.5 md:w-4 md:h-4 flex items-center justify-center font-bold text-xs md:text-sm">₦</span></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Discounts</p>
                                    <h3 className="text-sm md:text-xl font-bold text-orange-500 mt-1">₦{totalDiscounts.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-orange-100 rounded-lg text-orange-600"><span className="w-3.5 h-3.5 md:w-4 md:h-4 flex items-center justify-center font-bold text-xs md:text-sm">₦</span></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Total Refunds</p>
                                    <h3 className="text-sm md:text-xl font-bold text-rose-500 mt-1">₦{totalRefunds.toLocaleString()}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-rose-100 rounded-lg text-rose-600"><TrendingDown className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                        <div className="bg-white p-3 md:p-5 rounded-xl shadow-sm border border-slate-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    <p className="text-slate-500 text-[8px] md:text-[10px] font-bold uppercase tracking-wider">Transactions</p>
                                    <h3 className="text-sm md:text-xl font-bold text-slate-800 mt-1">{totalTransactions}</h3>
                                </div>
                                <div className="p-1.5 md:p-2 bg-amber-100 rounded-lg text-amber-600"><ShoppingBag className="w-3.5 h-3.5 md:w-4 md:h-4" /></div>
                            </div>
                        </div>
                    </div>
